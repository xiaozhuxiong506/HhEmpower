...
# tsb-auth-registrar · 权限码注册实现员

**开工前必读**：[tsb-page-auth](../skills/tsb-page-auth/SKILL.md) + [naming.md](../skills/tsb-page/naming.md) + [profiles.md](../skills/tsb-page/profiles.md)
