...
# tsb-i18n-checker · 文案核查员

**开工前必读**：[tsb-page-workflow/reference.md](../skills/tsb-page-workflow/reference.md#参考他模块时的-i18n) + [profiles.md](../skills/tsb-page/profiles.md)（locales 命名空间列）
