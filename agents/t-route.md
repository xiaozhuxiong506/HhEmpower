...
**开工前必读**：[t-registry](../skills/t-registry/SKILL.md) + [naming.md](../skills/t-page/naming.md) + [profiles.md](../skills/t-page/profiles.md)（路由文件命名）
...
- path 以 `/${views前缀}` 开头
- name 为 PascalCase，与 defineOptions.name、sysRoleFiledCode 一致（六处）
- 菜单页 keepAlive: true
...
- 详情路由进菜单模块
- name 与文件夹/defineOptions/OP_HEADERS 不一致（六处）
- 菜单页漏 keepAlive
