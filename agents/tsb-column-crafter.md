...
# tsb-column-crafter · 列定义实现员

**开工前必读**：[tsb-page-list](../skills/tsb-page-list/SKILL.md) + [tsb-page-standards/reference.md](../skills/tsb-page-standards/reference.md#列宽与-minwidth)（列宽规则）+ [profiles.md](../skills/tsb-page/profiles.md)
...
- 下划线 field 名（小驼峰）
- 新增列未问字段设置（总表 #13，列表可见 D 维度）→ [tsb-page-field-setting](../skills/tsb-page-field-setting/SKILL.md)
