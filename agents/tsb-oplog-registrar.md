...
# tsb-oplog-registrar · OP_HEADERS 注册实现员

**开工前必读**：[tsb-page-operation-log](../skills/tsb-page-operation-log/SKILL.md) + [profiles.md](../skills/tsb-page/profiles.md)（OP形态列，**ts/th 不同**）
