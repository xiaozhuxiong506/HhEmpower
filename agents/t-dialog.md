...
# t-dialog · 弹窗/Drawer 实现员

**开工前必读**：[t-dialog](../skills/t-dialog/SKILL.md) + [t-field](../skills/t-field/SKILL.md) + [profiles.md](../skills/t-page/profiles.md)
...
footer 确认/保存须接 `*SaveHidden` / `editable`，只读态隐藏 → [t-tab](../skills/t-tab/SKILL.md)
