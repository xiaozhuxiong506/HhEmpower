...
未梳理清楚前不写代码。提问格式 → [tsb-page-workflow 总表 #14](../tsb-page-workflow/reference.md#必问单选题总表)
...
关联：[tsb-page-list](../tsb-page-list/SKILL.md) · [tsb-page-detail](../tsb-page-detail/SKILL.md) · [tsb-page-dialog](../tsb-page-dialog/SKILL.md) · [tsb-page-registry](../tsb-page-registry/SKILL.md)（见 Tab 四种模式节）
