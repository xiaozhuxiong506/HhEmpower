...
标准：照抄 [anchors.md](../tsb-page/anchors.md) 中当前项目标准页的 `auth.ts`（ts→tsMaterialOrdering；th→thCustomerInfo）
...
提问格式统一 → [tsb-page-workflow/reference.md#必问单选题总表](../tsb-page-workflow/reference.md#必问单选题总表)
...
关联：[tsb-page-list](../tsb-page-list/SKILL.md) · [tsb-page-detail](../tsb-page-detail/SKILL.md)
