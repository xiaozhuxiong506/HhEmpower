...
> 项目特定值（标准页/前缀/路由文件/API文件）→ 先读 [../tsb-page/profiles.md](../tsb-page/profiles.md)。
...
- 有 Tab 时按 tsb-page-registry 判断 filter/component 模式并检子组件
...
- 新增表单/列字段 → AskQuestion 总表 #13 → [tsb-page-field-setting](../tsb-page-field-setting/SKILL.md)
