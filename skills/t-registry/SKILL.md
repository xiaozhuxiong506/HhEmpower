...
编码规范 → [t-standards](../t-standards/SKILL.md) · [naming.md](../t-page/naming.md)

## 第 0 步：探测项目

先读 [profiles.md](../t-page/profiles.md)，判定 ts/th，路由文件命名按对应列（ts→`ts{模块}Management.ts`；th→`th{模块}.ts`）。
...
确切项目命名见 [profiles.md](../t-page/profiles.md) 路由模块文件列。
...
- 检：**Tab 可编辑矩阵** — 哪些 Tab 不可保存/不可新增 → [t-tab](../t-tab/SKILL.md)
...
2. 六处一致 → [t-standards](../t-standards/SKILL.md) · [naming.md](../t-page/naming.md)
3. 若菜单列表页 → [t-module](../t-module/SKILL.md) 全流程
...
关联：[t-workflow](../t-workflow/SKILL.md) · [t-module](../t-module/SKILL.md)
